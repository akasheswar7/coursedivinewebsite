...
import { Search, BookOpen, Calendar, Clock, ArrowRight, Sparkles, X } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-sm mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              placeholder="Search tech articles (e.g. AI, Cloud, VLSI)..."
              className="w-full pl-9 pr-8 py-2.5 rounded-xl border border-slate-200 text-xs focus:outline-none focus:ring-2 focus:ring-brand-500"
            />
            {search && (
              <button
                type="button"
